...
echo
echo "Step 1: Launch config:"
echo "        cd ${trex_dir}"
echo "        ${trex_dir}/trex-console --batch ${git_base_path}/beta/trex-init-script.conf"
echo
echo "Step 2: Launch streams:"
echo "        ${git_base_path}/beta/trex-load-64byte-base.sh"
echo
echo "Step 3: Launch the TRex Console:"
