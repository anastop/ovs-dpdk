...
vm_2_pid=`ps awx | grep VPP-VM1 | grep -v grep | awk '{print $1}'`
vm_2_cpu0_pid=`top -n 1 -H -p ${vm_2_pid} | grep "CPU 0" | awk '{print $1}'`
vm_2_cpu1_pid=`top -n 1 -H -p ${vm_2_pid} | grep "CPU 1" | awk '{print $1}'`
vm_2_cpu2_pid=`top -n 1 -H -p ${vm_2_pid} | grep "CPU 2" | awk '{print $1}'`
vm_2_cpu3_pid=`top -n 1 -H -p ${vm_2_pid} | grep "CPU 3" | awk '{print $1}'`
taskset -pc -a ${cpu_vm1_core0} ${vm_2_pid}
taskset -pc ${cpu_vm1_core0} ${vm_2_cpu0_pid}
taskset -pc ${cpu_vm1_core1} ${vm_2_cpu1_pid}
taskset -pc ${cpu_vm1_core2} ${vm_2_cpu2_pid}
taskset -pc ${cpu_vm1_core3} ${vm_2_cpu3_pid}
echo
