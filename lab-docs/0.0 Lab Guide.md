...
2. Verify the impact of Intel® SST-BF on the CPU cores
3. Prepare the lab server for the workload test
4. Perform the workload test and observe the impact of Intel® SST-BF
5. Reset the lab server configuration
6. (OPTIONAL) Perform additional workload testing.
