...
then
	...
	echo
	sleep 1
	echo "Running: "${git_base_path}/scripts/cpu-set.sh ${vm_name} ${cpu_vm1_core0} ${cpu_vm1_core1} ${cpu_vm1_core2} ${cpu_vm1_core3}
	echo
	${git_base_path}/scripts/cpu-set.sh ${vm_name} ${cpu_vm1_core0} ${cpu_vm1_core1} ${cpu_vm1_core2} ${cpu_vm1_core3}
fi
...
then
	...
	echo
	sleep 1
	echo "Running: "${git_base_path}/scripts/cpu-set.sh ${vm_name} ${cpu_vm2_core0} ${cpu_vm2_core1} ${cpu_vm2_core2} ${cpu_vm2_core3}
	echo
	${git_base_path}/scripts/cpu-set.sh ${vm_name} ${cpu_vm2_core0} ${cpu_vm2_core1} ${cpu_vm2_core2} ${cpu_vm2_core3}
fi
