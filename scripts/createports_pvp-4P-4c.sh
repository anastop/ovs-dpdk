...
sleep 8
./utilities/ovs-vsctl add-port br0 dpdk2 -- set Interface dpdk2 type=dpdk options:dpdk-devargs=0000:1a:00.0 other_config:pmd-rxq-affinity="0:4"
sleep 8
./utilities/ovs-vsctl add-port br0 dpdk3 -- set Interface dpdk3 type=dpdk options:dpdk-devargs=0000:1a:00.1 other_config:pmd-rxq-affinity="0:5"
sleep 8
